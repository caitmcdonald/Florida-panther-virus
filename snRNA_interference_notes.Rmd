...
Following trimming with cutadapt, we can double check that adapter content has been removed by re-running the `fastqc.sh` script. Even though we got warnings from cutadapt about our R2 libraries, all libraries now pass the adapter content flag (adapter content ≤0.1%).
